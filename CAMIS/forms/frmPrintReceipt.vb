...
Public Class frmPrintReceipt
    ...
    Private Sub LoadItemstoDatagrid()
        Dim y As Integer
        Try
            sqL = "Select SUM(Quantity) as TotalQuantity, Description, ItemPrice, (ItemPrice * SUM(Quantity)) as Amount FROM Product as P, TransactionDetails as TD WHERE TD.ProductNo = P.ProductNo AND InvoiceNo ='" & frmSales.txtInvoiceNo.Text & "' GROUP BY TD.ProductNo"
            ConnDB()
